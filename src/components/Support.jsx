...
import { PhoneIcon, ArrowUpRightIcon } from "@heroicons/react/24/outline";
...
const Support = () => {
  return (
    <div name="support" className="w-full  m-auto">
      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        <div className="px-4 py-12">
          ...
          <p className="py-4 text-3xl text-slate-300 mx-4">
          ...
          <div className="bg-white rounded-xl shadow-2xl">
            ...
            <div className="bg-slate-100 pl-8 py-4">
              <p className="flex items-center text-indigo-600">
                Contact Us <ArrowUpRightIcon className="w-5 ml-2" />
              </p>
            </div>
          </div>
          <div className="bg-white rounded-xl shadow-2xl">
